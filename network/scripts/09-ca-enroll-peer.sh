...
fabric-ca-client enroll -d -u https://$1$2:$1$2pw@localhost:$PORT --mspdir ../organizations/peerOrganizations/$1/peers/$2/msp --csr.hosts "apmi5,localhost,$IP" --tls.certfiles tls-root-cert/tls-ca-cert.pem

mkdir organizations/peerOrganizations/$1/peers/$2/tls
