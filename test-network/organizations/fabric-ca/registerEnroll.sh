...
function createOpepatorOrg() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:11054 --caname operator-org --tls.certfiles "${PWD}/organizations/fabric-ca/operator/ca-cert.pem"
  { set +x; } 2>/dev/null

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-11054-ca-operator.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: cacerts/localhost-11054-ca-operator.pem
    OrganizationalUnitIdentifier: peer
  ...
  mkdir -p "${PWD}/organizations/peerOrganizations/operator/msp/tlscacerts"
  ...
  infoln "Registering peer0"
  set -x
  fabric-ca-client register --caname operator --id.name peer0 --id.secret peer0pw --id.type peer --tls.certfiles "${PWD}/organizations/fabric-ca/operator/ca-cert.pem"
  { set +x; } 2>/dev/null

  infoln "Registering user"
  set -x
  fabric-ca-client register --caname operator --id.name user1 --id.secret user1pw --id.type client --tls.certfiles "${PWD}/organizations/fabric-ca/operator/ca-cert.pem"
  { set +x; } 2>/dev/null

  infoln "Registering the org admin"
  set -x
  fabric-ca-client register --caname operator --id.name operatoradmin --id.secret operatoradminpw --id.type admin --tls.certfiles "${PWD}/organizations/fabric-ca/operator/ca-cert.pem"
  { set +x; } 2>/dev/null
  
  infoln "Generating the peer0 msp"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:11054 --caname operator -M "${PWD}/organizations/peerOrganizations/operator.by/peers/peer0.operator.by/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/operator/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the peer0-tls certificates, use --csr.hosts to specify Subject Alternative Names"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:11054 --caname operator -M "${PWD}/organizations/peerOrganizations/operator/peers/operator.by/tls" --enrollment.profile tls --csr.hosts peer0.operator.by --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/operator/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@localhost:11054 --caname operator -M "${PWD}/organizations/peerOrganizations/operator.by/users/User1@operator.by/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/operator/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the org admin msp"
  set -x
  fabric-ca-client enroll -u https://operatoradmin:operatoradminpw@localhost:11054 --caname operator -M "${PWD}/organizations/peerOrganizations/operator.by/users/Admin@operator.by/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/operator/ca-cert.pem"
  { set +x; } 2>/dev/null
