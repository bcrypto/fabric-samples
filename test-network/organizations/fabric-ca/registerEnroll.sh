...
function createOpepatorOrg() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:11054 --caname ca-operator-org --tls.certfiles "${PWD}/organizations/fabric-ca/operator/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the peer0 msp"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:11054 --caname ca-operator-org -M "${PWD}/organizations/peerOrganizations/operator.by/peers/peer0.operator.by/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/operator/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the peer0-tls certificates, use --csr.hosts to specify Subject Alternative Names"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:11054 --caname ca-operator-org -M "${PWD}/organizations/peerOrganizations/operator/peers/operator.by/tls" --enrollment.profile tls --csr.hosts peer0.operator.by --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/operator/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@localhost:11054 --caname ca-operator-org -M "${PWD}/organizations/peerOrganizations/operator.by/users/User1@operator.by/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/operator/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the org admin msp"
  set -x
  fabric-ca-client enroll -u https://operatoradmin:operatoradminpw@localhost:11054 --caname ca-operator-org -M "${PWD}/organizations/peerOrganizations/operator.by/users/Admin@operator.by/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/operator/ca-cert.pem"
  { set +x; } 2>/dev/null
